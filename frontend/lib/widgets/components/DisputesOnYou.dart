  ...
  Widget build(BuildContext context) {
    return Card(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Container(margin: const EdgeInsets.symmetric(vertical: 15, horizontal: 12), child: LongButton(handler: () => Navigator.of(context).pushNamed(DisputeTabs.routeName, arguments: {'initialIndex': 1}), buttonText: 'More', isActive: true))
        ]));
  }
}
