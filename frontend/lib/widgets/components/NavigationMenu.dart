        ...
        child: Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Row(children: [
                Expanded(
                  child: CardButton(
                      const Color(0xffEABD2A), Icons.commute, 'Ride', () {}),
                ),
                Expanded(
                  child: CardButton(const Color(0xff5CCB57), Icons.attach_money,
                      'Earn', () {}),
                ),
                Expanded(
              ...
              Row(children: [
                CardButton(const Color(0xff771AF0), Icons.account_circle_sharp,
                    'Profile', () {}),
              ]),
            ])),
      ),
